  ...
  return (
    <div className="insta-container">
      ...
      <div className="add-story">
        ...
        <button onClick={handleAddStory}> <FontAwesomeIcon icon={faPlus} size="lg" className='story bg-light rounded-circle' />
        <input
          type="file"
      ...
      {/* <button onClick={handleAddStory}> <FontAwesomeIcon icon={faPlus} size="lg" className='bg-light rounded-circle' />;</button> */}
      {selectedStory !== null && (
        <div
